...
import org.apache.log4j._
  ...
  object MostPopularSuperhero {
    ...
    def main(args: Array[String]) {
      ...
      val names = sc.textFile("/Users/Akash/Documents/Main/Apache_Spark/SparkScala/Marvel-names.txt")
      val namesRdd = names.flatMap(parseNames)

      // Load up the superhero co-apperarance data
      val lines = sc.textFile("/Users/Akash/Documents/Main/Apache_Spark/SparkScala/Marvel-graph.txt")
