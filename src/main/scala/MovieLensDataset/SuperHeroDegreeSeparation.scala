...
/**
  ...
  */
object SuperHeroDegreeSeparation {


  // The characters we want to find the separation between.
  val startCharacterID = 5306 //SpiderMan
  val targetCharacterID = 6307 //ADAM 3,031 (who?)
  ...
  def createStartingRdd(sc:SparkContext): RDD[BFSNode] = {
    val inputFile = sc.textFile("/Users/Akash/Documents/Main/Apache_Spark/SparkScala/Marvel-graph.txt")
